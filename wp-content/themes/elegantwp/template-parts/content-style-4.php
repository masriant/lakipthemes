...
<div id="post-<?php the_ID(); ?>" class="elegantwp-fp04-post">
    ...
    <div class="elegantwp-fp04-post-thumbnail">
        <a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php /* translators: %s: post title. */ echo esc_attr( sprintf( __( 'Permanent Link to %s', 'elegantwp' ), the_title_attribute( 'echo=0' ) ) ); ?>" class="elegantwp-fp04-post-thumbnail-link"><?php the_post_thumbnail('elegantwp-medium-image', array('class' => 'elegantwp-fp04-post-thumbnail-img')); ?></a>
    </div>
    <?php } ?>
    <?php } ?>
    ...
    <?php if ( !(elegantwp_get_option('hide_read_more_button')) ) { ?><div class='elegantwp-fp04-post-read-more'><a href="<?php echo esc_url( get_permalink() ); ?>"><?php echo esc_html( elegantwp_read_more_text() ); ?><span class="screen-reader-text"> <?php the_title(); ?></span></a></div><?php } ?>
